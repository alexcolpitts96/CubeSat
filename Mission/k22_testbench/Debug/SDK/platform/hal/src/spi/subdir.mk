...
C_SRCS += \
../SDK/platform/hal/src/spi/fsl_spi_hal.c 

OBJS += \
./SDK/platform/hal/src/spi/fsl_spi_hal.o 

C_DEPS += \
./SDK/platform/hal/src/spi/fsl_spi_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/spi/%.o: ../SDK/platform/hal/src/spi/%.c
	@echo 'Building file: $<'
