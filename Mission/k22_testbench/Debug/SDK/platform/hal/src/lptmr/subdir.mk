...
C_SRCS += \
../SDK/platform/hal/src/lptmr/fsl_lptmr_hal.c 

OBJS += \
./SDK/platform/hal/src/lptmr/fsl_lptmr_hal.o 

C_DEPS += \
./SDK/platform/hal/src/lptmr/fsl_lptmr_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/lptmr/%.o: ../SDK/platform/hal/src/lptmr/%.c
	@echo 'Building file: $<'
