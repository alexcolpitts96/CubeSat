...
C_SRCS += \
../SDK/platform/system/src/clock/MKL02Z4/fsl_clock_MKL02Z4.c 

OBJS += \
./SDK/platform/system/src/clock/MKL02Z4/fsl_clock_MKL02Z4.o 

C_DEPS += \
./SDK/platform/system/src/clock/MKL02Z4/fsl_clock_MKL02Z4.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/system/src/clock/MKL02Z4/%.o: ../SDK/platform/system/src/clock/MKL02Z4/%.c
	@echo 'Building file: $<'
