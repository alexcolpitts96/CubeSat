...
C_SRCS += \
../SDK/platform/hal/src/smc/fsl_smc_hal.c 

OBJS += \
./SDK/platform/hal/src/smc/fsl_smc_hal.o 

C_DEPS += \
./SDK/platform/hal/src/smc/fsl_smc_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/smc/%.o: ../SDK/platform/hal/src/smc/%.c
	@echo 'Building file: $<'
