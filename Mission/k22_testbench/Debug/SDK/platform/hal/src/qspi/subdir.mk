...
C_SRCS += \
../SDK/platform/hal/src/qspi/fsl_qspi_hal.c 

OBJS += \
./SDK/platform/hal/src/qspi/fsl_qspi_hal.o 

C_DEPS += \
./SDK/platform/hal/src/qspi/fsl_qspi_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/qspi/%.o: ../SDK/platform/hal/src/qspi/%.c
	@echo 'Building file: $<'
