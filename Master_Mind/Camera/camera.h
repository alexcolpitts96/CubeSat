...
#define start_capture() SPI1_TX(0x8101);\
						SPI1_TX(0x8402)
...
struct ov2640_reg_cfg JPEG_LARGE[] =
{
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02Ϊ\B2\CA\CC\F5
...
// 640x480 jpeg
struct ov2640_reg_cfg JPEG_MID[] =
{
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02Ϊ\B2\CA\CC\F5
...
struct ov2640_reg_cfg JPEG_MINI[] =
{
  { 0xff, 0x01 },
  { 0x12, 0x40 },
  { 0x17, 0x11 },
...
struct ov2640_reg_cfg JPEG_1024[] =
{
	{0xff, 0x01},
	{0x11, 0x01},
	{0x12, 0x00}, // Bit[6:4]: Resolution selection//0x02Ϊ\B2\CA\CC\F5
