...
C_SRCS += \
../SDK/platform/hal/src/slcd/fsl_slcd_hal.c 

OBJS += \
./SDK/platform/hal/src/slcd/fsl_slcd_hal.o 

C_DEPS += \
./SDK/platform/hal/src/slcd/fsl_slcd_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/slcd/%.o: ../SDK/platform/hal/src/slcd/%.c
	@echo 'Building file: $<'
