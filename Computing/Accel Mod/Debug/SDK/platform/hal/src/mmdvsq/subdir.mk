...
C_SRCS += \
../SDK/platform/hal/src/mmdvsq/fsl_mmdvsq_hal.c 

OBJS += \
./SDK/platform/hal/src/mmdvsq/fsl_mmdvsq_hal.o 

C_DEPS += \
./SDK/platform/hal/src/mmdvsq/fsl_mmdvsq_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/mmdvsq/%.o: ../SDK/platform/hal/src/mmdvsq/%.c
	@echo 'Building file: $<'
