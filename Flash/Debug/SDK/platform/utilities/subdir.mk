...
../SDK/platform/utilities/print_scan.c 

OBJS += \
./SDK/platform/utilities/fsl_debug_console.o \
./SDK/platform/utilities/print_scan.o 

C_DEPS += \
./SDK/platform/utilities/fsl_debug_console.d \
./SDK/platform/utilities/print_scan.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/utilities/%.o: ../SDK/platform/utilities/%.c
	@echo 'Building file: $<'
