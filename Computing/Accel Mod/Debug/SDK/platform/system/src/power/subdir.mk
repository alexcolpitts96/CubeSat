...
C_SRCS += \
../SDK/platform/system/src/power/fsl_power_manager.c 

OBJS += \
./SDK/platform/system/src/power/fsl_power_manager.o 

C_DEPS += \
./SDK/platform/system/src/power/fsl_power_manager.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/system/src/power/%.o: ../SDK/platform/system/src/power/%.c
	@echo 'Building file: $<'
