...
C_SRCS += \
../SDK/platform/hal/src/tpm/fsl_tpm_hal.c 

OBJS += \
./SDK/platform/hal/src/tpm/fsl_tpm_hal.o 

C_DEPS += \
./SDK/platform/hal/src/tpm/fsl_tpm_hal.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/hal/src/tpm/%.o: ../SDK/platform/hal/src/tpm/%.c
	@echo 'Building file: $<'
