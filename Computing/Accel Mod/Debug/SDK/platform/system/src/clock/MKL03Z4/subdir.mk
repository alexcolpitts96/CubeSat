...
C_SRCS += \
../SDK/platform/system/src/clock/MKL03Z4/fsl_clock_MKL03Z4.c 

OBJS += \
./SDK/platform/system/src/clock/MKL03Z4/fsl_clock_MKL03Z4.o 

C_DEPS += \
./SDK/platform/system/src/clock/MKL03Z4/fsl_clock_MKL03Z4.d 


# Each subdirectory must supply rules for building sources it contributes
SDK/platform/system/src/clock/MKL03Z4/%.o: ../SDK/platform/system/src/clock/MKL03Z4/%.c
	@echo 'Building file: $<'
